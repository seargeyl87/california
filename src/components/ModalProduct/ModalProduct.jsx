    ...
    return (
        <div className="modal-product">
             ...
             <div className="modal-search_product_head-description">
                        <div className="modal-search_product_head-description_head">{item.name}</div>
                        <div className="modal-search_product_head-description_description">{item.description}</div>
             </div>
